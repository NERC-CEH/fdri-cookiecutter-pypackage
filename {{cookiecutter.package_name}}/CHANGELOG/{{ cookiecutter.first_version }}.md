...
{% if cookiecutter.git_hosting == "github" %}- CI via GitHub Actions (NERC-CEH/dri-cicd reusable workflows)
{% endif %}{% if cookiecutter.docs_type == "sphinx" %}- Docs site with Sphinx + Shibuya theme{% if cookiecutter.git_hosting == "github" %}, auto-deployed to GitHub Pages{% endif %}
